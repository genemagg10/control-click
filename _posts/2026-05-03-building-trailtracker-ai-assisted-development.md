...
The naive plan: export from Apple Health (a `.zip`), upload to the website, parse in the browser. The agent built that. I tried it with my own export, all 200 MB of it. The browser tab spun for several minutes, then refreshed itself with no data imported.
